...
{
    public static long	ARRAY_TYPENUM = 0x0001;
    public static long	ARRAY_TYPETXT = 0x0002;
    public static long	INDEX_BASE1 = 0x0004;
    ...
    public CRunKcArrayData(int flags, int dimX, int dimY, int dimZ) 
    {
