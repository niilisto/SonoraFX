...
public class CRunAndroid extends CRunExtension
{
	...
	public void action(int num, CActExtension act)
	{
		...
		case 30: /* Disable hardware keys for old devices api 11 and below */
			...
			if(!MMFRuntime.inst.checkForPermission(Manifest.permission.DISABLE_KEYGUARD))
				break;
		...
		case 35: /* Hide Navigation Bar */
			MMFRuntime.inst.toogleNavigationBar(false, 2 + (MMFRuntime.deviceApi > 15 ? 1024|4 : 0) + (MMFRuntime.deviceApi > 18 ? 4096|2048 : 0)); //512|
			break;     
