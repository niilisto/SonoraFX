...
//    }
    ...
    public int GetContainer(CRunKcBoxA re)
    {
        ...
        if (this.pContainers != null)
        {
           ...
           //     }
           //} 
        	for (CRunKcBoxA reThisOne : this.pContainers)
            {
    ...
    public int GetObjectFromList(int x, int y)
    {
        ...
        if (this.pObjects != null)
        {
            ...
            //    }
            //}
        	Vector<CRunKcBoxA> tmpList = (Vector<CRunKcBoxA>)this.pObjects.clone();
        	Collections.reverse(tmpList);
        	for (CRunKcBoxA reThisOne : tmpList)
        	{
        		if(reThisOne == null)
        			continue;
...
//    }
    ...
    public void UpdateContainedPos()//CRunKcBoxA re)
    {
    	if (this.pObjects != null)
    	{
    		...
    		//    }
    		//}
    		for (CRunKcBoxA reThisOne : this.pObjects)
    		{
        		if(reThisOne == null)
        			continue;
