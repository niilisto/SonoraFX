...
public class ACT_EXTSETLINEARVELOCITY extends CAct
{
	public override function execute(rhPtr:CRun):void {
        ...
        {
            var param1:Number= rhPtr.get_EventExpressionDouble(CParamExpression(evtParams[0]));
            var param2:Number= rhPtr.get_EventExpressionDouble(CParamExpression(evtParams[1]));
