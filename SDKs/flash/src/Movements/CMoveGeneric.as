...
package Movements
{
	...
	public class CMoveGeneric extends CMove
	{
	    ...
	    public override function init(ho:CObject, mvPtr:CMoveDef):void
	    {
	        ...
	        var mgPtr:CMoveDefGeneric=CMoveDefGeneric(mvPtr);
	    ...
	    public override function move():void
	    {
			var direction:int;
			var autorise:int;
			var speed:int, speed8:int, dir:int;
			...
			if (MG_Bounce==0)
	        {
	            ...
	            autorise=0;
	            {
					var j:int=hoPtr.hoAdRunHeader.rhPlayer[hoPtr.roc.rcPlayer-1]&15;
					if (j!=0)
					{
	                    dir=Joy2Dir[j];
	                    if (dir!=-1)
	    ...
	    public function set8DirsGeneric(dirs:int):void
	    {
			MG_OkDirs=dirs;
	    }
	}
