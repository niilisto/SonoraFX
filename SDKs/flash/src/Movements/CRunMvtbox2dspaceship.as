...
package Movements {
	...
	public class CRunMvtbox2dspaceship extends CRunMBase
	{
		public static const B2FLAG_ROTATE:int=0x0001;
		public static const B2FLAG_FINECOLLISIONS:int=0x0004;
		public static const ACCMULT:Number=10.0;
		public static const DECMULT:Number=7.5;
		public static const ANGLEMULT:Number=3.0;
		...
		public var m_thruster:Number= 0;
		public var m_rotationSpeed:Number= 0;
		public var m_initialImpulse:Number= 0;
		public var m_deceleration:Number= 0;
		public var m_angleSpeed:Number= 0;
		public var m_autoRotateLeft:Boolean= false;
		public var m_autoRotateRight:Boolean= false;
		public var m_autoReactor:Boolean= false;
		...
		public override function initialize(file:CBinaryFile):void {
			...
			file.skipBytes(1);
			this.m_currentAngle=this.dirAtStart(file.readInt())*180.0/16.0;
			...
			var power:int= file.readInt();
			this.m_power=(power/(100.0*CRunMvtbox2dspaceship.ACCMULT));
			this.m_thruster=file.readShort();
			this.m_angleSpeed=(50.0*file.readInt()/(100.0*CRunMvtbox2dspaceship.ANGLEMULT));
			this.m_initialImpulse=file.readInt()/100.0*10.0;
			this.m_deceleration=file.readInt()/(100.0*CRunMvtbox2dspaceship.DECMULT);
			this.m_player=file.readShort();
		...
		public override function CreateBody():Boolean {
			...
			this.m_body = this.m_base.rCreateBody(b2Body.b2_dynamicBody, this.ho.hoX, this.ho.hoY, this.m_currentAngle, this.m_gravity, this, 0, 0);
			if (this.ho.roa == null)
			{
				this.m_shape = 0;
			...
			var mass:Number= this.m_body.GetMass();
		...
		private function SetCurrentAngle():void {
			if (this.m_currentAngle!=this.m_previousAngle)
			{
				...
				this.ho.roc.rcChanged=true;
				if ((this.m_flags&CRunMvtbox2dspaceship.B2FLAG_ROTATE)!=0)
				{
		...
		public override function setAcc(acc:int):void {
			this.m_power=Number(acc)/(100.0*ACCMULT);
		}
		...
		public override function getAcceleration():int {
			return int(this.m_power*(100.0*ACCMULT));
		}
		...
		public override function setRotSpeed(speed:int):void {
			this.m_angleSpeed=(50.0*speed/(100.0*ANGLEMULT));
		}
