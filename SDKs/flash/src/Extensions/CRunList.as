...
package Extensions
{
	...
	public class CRunList
	{
		...
		public var slider:CRunVScrollBar;
		public var bClick:Boolean;
		public var bDoubleClick:Boolean;
		public var bEnabled:Boolean;
		public var bSelChanged:Boolean;
		
		public function CRunList(p:DisplayObjectContainer, xx:int, yy:int, w:int, h:int, ft:CFontInfo, ftColor:int, bkColor:int, fl:int)
		{
			parent=p;
			x=xx;
			y=yy;
		...
		public function createDisplay():void
		{
			...
			{
				slider=new CRunVScrollBar(sprite, width-sBorder-CRunVScrollBar.SX_BUTTON, sBorder, CRunVScrollBar.SX_BUTTON, trueHeight-sBorder*2);
