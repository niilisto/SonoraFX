...
package Services 
{
	...
	/**
	 * ...
	 * @author Roman (Tools -> Custom Arguments...)
	 */
	public class CChunk 
	{
	...
	//	  public static short CHUNK_BLURAYAPPOPTIONS=0x3344
	//	  public static short CHUNK_APPHDR2=0x3345
	...
	//    public static short CHUNK_BLURAYFRAMEOPTIONS=0x3346;
		//	CHUNK_FRAMEEFFECTS=0x3347
		//	CHUNK_FRAME_IPHONE_OPTIONS=0x3348
	...
	//    public static short CHUNK_MUSICS=0x6669;
	    ...
	    public function readHeader(file:CFile):int  
	    {
	    ...
	    public function skipChunk(file:CFile):void  
	    {
